...
apt-get update && \
apt-get install -y wget acl apache2 php5-gd php-pear php5-mcrypt php5-xcache php5-xmlrpc php5 php5-sqlite unzip git openssl rsync php5-imagick imagemagick ghostscript subversion php-mail-mimedecode tar gzip bzip2 curl php5-curl php5-dev php5-imap ssmtp php5-mysql && \
